    ...
    return (
        <main>
            ...
            <div className={"flex flex-col justify-center items-center w-full m-auto gap-3"}>
                ...
                <p className={"text-white my-10 gap-2"}> <span className={"font-bold"}>Merknad: </span> Åpningstider kan avvike grunnet ferie, sjekk <span className={"font-bold"}>Facebook siden </span> vår for de nyeste oppdateringene</p>
            </div>
        </main>
