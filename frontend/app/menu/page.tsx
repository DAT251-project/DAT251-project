    ...
    return (
        <section className={"relative bg-custom-eggwhite min-h-[70dvh] h-full"}>
            <Container style={"flex flex-col items-center h-full justify-center gap-10"}>
                ...
                <div className={"flex flex-col gap-5 text-center lg:text-xl font-title"}>
                    <a href={"/menu/menu-NO-2025.pdf"} className={"default-btn bg-custom-red border-custom-red text-white hover:bg-custom-eggwhite hover:text-custom-red"}>Meny</a>
            ...
            <Image src={"/drawings/noodles.png"} width={200} height={200} className={"absolute z-1 bottom-0 left-0 w-40 md:w-50 lg:w-50 2xl:w-70 opacity-70"}
